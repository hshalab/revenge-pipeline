...
# Back down to 3 slots/day (2026-08-xx, user decision: "boros cost", cut
# from the 8-slots-a-day competitor-cadence experiment). See
# project_golden_child_thumbnail_baseline.md for the pre-experiment
# [(10, 30)] single-slot value if this needs reverting further.
#
